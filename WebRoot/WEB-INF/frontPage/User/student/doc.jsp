...
<body>
	...
	<input id="totalCountDocStu" value="${totalCountDocStu }" type="hidden"/>
	<fieldset id="pagerDocStu" class="layui-elem-field layui-field-title" style="margin-top: 30px;text-align:center;"> </fieldset>
</body>
<script type="text/javascript">
	var pageNumDocStu = 0;
	$(function() {
		pageHelperDocStu(callbackDocStu);
	})
	
	function callbackDocStu(num){
		pageNumDocStu = num;
		$.ajax({
			...
			success : function(data) {
				...
				$(data.words).each(function(idx, obj) {
					var item = generateItemDocStu(obj);
	...
	var pageHelperDocStu = function(callback){
	...
	function generateItemDocStu(obj){
		var tr = $("<tr></tr>");
