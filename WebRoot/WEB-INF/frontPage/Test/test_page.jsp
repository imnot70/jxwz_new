		...
		<div class="wap-container">
			...
			<div class="container ui-sortable">
				<div class="panel panel-default">
					<div class="panel-header">选择章节</div>
						...
						<c:forEach items="${chapters }" var="item" varStatus="vs">
							<details >
								...
								<c:forEach items="${item.sections }" var="subItem">
									<li class="Huialert Huialert-info sub_li" onclick="toTestPage('${subItem.id}')">${subItem.title }&nbsp;&nbsp;&nbsp;&nbsp;${subItem.subTitle}</li>
								</c:forEach>
							</details>
						</c:forEach>
					</div>
...
function toTestPage(sectionId){
	window.location.href="${pageContext.request.contextPath}/test_toTestList.action?sectionId="+sectionId;
}
